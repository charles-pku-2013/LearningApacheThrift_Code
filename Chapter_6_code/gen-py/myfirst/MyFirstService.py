...
class Client(Iface):
  ...
  def recv_divide(self):
    ...
    if result.success is not None:
      return result.success
    if result.zero_error is not None:
      raise result.zero_error
    if result.type_error is not None:
      raise result.type_error
...
class Processor(Iface, TProcessor):
  ...
  def process_divide(self, seqid, iprot, oprot):
    ...
    except DivisionByZeroError, zero_error:
      result.zero_error = zero_error
    except WrongTypeError, type_error:
...
class divide_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.DOUBLE, 'number1', None, None, ), # 1
    (2, TType.DOUBLE, 'number2', None, None, ), # 2
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.DOUBLE:
          self.number1 = iprot.readDouble();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.DOUBLE:
          self.number2 = iprot.readDouble();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.number1 is not None:
      oprot.writeFieldBegin('number1', TType.DOUBLE, 1)
      oprot.writeDouble(self.number1)
      oprot.writeFieldEnd()
    if self.number2 is not None:
      oprot.writeFieldBegin('number2', TType.DOUBLE, 2)
      oprot.writeDouble(self.number2)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class divide_result:
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'zero_error', (DivisionByZeroError, DivisionByZeroError.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'type_error', (WrongTypeError, WrongTypeError.thrift_spec), None, ), # 2
  )

  def __init__(self, success=None, zero_error=None, type_error=None,):
    self.success = success
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        ...
        if ftype == TType.STRUCT:
          self.zero_error = DivisionByZeroError()
          self.zero_error.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRUCT:
          self.type_error = WrongTypeError()
          self.type_error.read(iprot)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.zero_error is not None:
      oprot.writeFieldBegin('zero_error', TType.STRUCT, 1)
      self.zero_error.write(oprot)
      oprot.writeFieldEnd()
    if self.type_error is not None:
      oprot.writeFieldBegin('type_error', TType.STRUCT, 2)
      self.type_error.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.success)
    value = (value * 31) ^ hash(self.zero_error)
    value = (value * 31) ^ hash(self.type_error)
    return value
